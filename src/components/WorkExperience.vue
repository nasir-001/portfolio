      ...
      <div v-if="selected == 'bexil'" class="tw-ml-8">
        <div>
          <div class="tw-text-3xl">
            Frontend developer <span class="title tw-text-primary-text-color hover:tw-"><a href="https://bexilsolutions.com/" target="_blank" rel="noopener noreferrer">@Bexil</a></span>
          </div>
          <div class="tw-mt-5">
